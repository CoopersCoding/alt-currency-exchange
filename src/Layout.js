  ...
  return (
    <React.Fragment>
      ...
      <footer className="p-3 bg-light">
        <div className="mb-2">
        <h6><span className="badge bg-secondary"><a className="mr-3 " href="https://github.com/Altcademy/alt-currency-exchange" target="_blank" rel="noopener noreferrer">GitHub</a></span></h6>
        </div>
        <div>
